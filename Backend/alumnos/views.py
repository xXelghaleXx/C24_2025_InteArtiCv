...
GOOGLE_CLIENT_ID = '258181987281-jd71k4f6k0no7e61qk34mpvc6i7nh2sp.apps.googleusercontent.com'
GOOGLE_CLIENT_SECRET = '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'
...
class GoogleLoginView(APIView):
    ...
    def post(self, request):
        ...
        try:
            # Intentar encontrar al alumno por correo electrónico
            alumno, created = Alumno.objects.get_or_create(
                correo=correo,
                defaults={
                    'nombre': nombre,
                    # No necesitamos contraseña para autenticación con Google
                    # Podemos generar una aleatoria o dejarla vacía
                }
            )
            ...
            return Response({
                'status': 'error',
                'error': f'Error en la autenticación con Google: {str(e)}'
